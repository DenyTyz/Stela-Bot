...
"""
HTTPS Tunnel for the Stela API — Cloudflare Tunnel via pycloudflared.
...
4. Give it a name (e.g. stela-api) and click Save
...
6. Go to "Published Application Routes" tab → Add a Published Application Routes:
      Subdomain: stela-api   Domain: yourdomain.com   Service: http://localhost:8000
   (Or use any domain you have on Cloudflare)
7. Paste the token into your .env:
      CF_TUNNEL_TOKEN = "eyJhIjoiX..."
      CF_TUNNEL_URL   = "https://stela-api.yourdomain.com"
...
def start_tunnel() -> None:
    ...
    Called from Stela.py after keep_alive().
    """
