...
from discord import *
import discord
from utils.emoji import BOOST, ICONS_WARNING, INFO, MENTION, PREMIUM, TICK, TIME, TIMER_ALT1, U_ADMIN, ZDIL, ZHUMAN, STELAHAMMER, STELASYS
import aiosqlite
...
class NoPrefix(commands.Cog):
                ...
                for user_id in expired_users:
                    ...
                    f"**Removed By**: **{BotName}**\n"
                        ...
                        support = Button(
                            ...
                            url=f"https://discord.gg/steladev",
                        )
                        view = View()
    ...
    async def add_np(self, user, duration):
        ...
        embed = CV2Embed(
            ...
            description=f"You've been credited 2 months of global No Prefix for boosting our Partnered Servers. You can now use my commands without prefix. If you wish to remove it, please reach out [Support Server](https://discord.gg/steladev).",
            color=0xFF0000,
        )
        try:
