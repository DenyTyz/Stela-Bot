...
import asyncio
import discord
from utils.emoji import CROSS, TICK, ZWARNING, STELACONNECTION, STELALINKS
...
class General(commands.Cog):
  ...
  async def invite(self, ctx: commands.Context):
      invite_text = (
          ...
          "**[Support Server](https://discord.gg/steladev)**"
      )
      await ctx.send(view=CV2(f"{STELACONNECTION} {BotName} Integration Hub!", invite_text))