    ...
    async def _get_response (self ,message :str ,history :list ,guild_id :int ,user_id :int =None )->str :
        try :
            ...
            if user_personality :
                ...
                system_context .append ({
                "role":"system",
                "content":"You are a Discord bot with many features including moderation, entertainment, music, games, AI capabilities, and utilities. Support server: https://discord.gg/steladev"
                })
            else :
