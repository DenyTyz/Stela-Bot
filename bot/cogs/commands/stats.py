...
import discord
from utils.emoji import CODEBASE, LOADING, SYSTEM, THUNDER, STELA_CODE, STELA_COMMAND, STELA_GLOBAL, STELA_OWNER, STELA_SEARCH
import psutil
import sys
import os
import time
...
def create_stats_content(stats_data, selected):
    content_map = {
        ...
        "System Info": (
            ...
            f"**{STELA_CODE} Software**\n"
            f"Python: **{sys.version_info.major}.{sys.version_info.minor}**\n"
            f"Discord.py: **{discord.__version__}**"
        ),
        "General Info": (
            f"**Uptime**: `{stats_data['uptime']}`\n\n"
            f"**{STELA_GLOBAL} Server Stats**\n"
            f"Guilds: **{stats_data['guilds']}**\n"
            f"Users: **{stats_data['users']}**\n\n"
            f"**{STELA_COMMAND} Commands Stats**\n"
