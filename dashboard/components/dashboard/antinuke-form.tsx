    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
      ...
      <div className="space-y-6">
         <div className="bg-gradient-to-br from-red-500/10 to-transparent border border-red-500/20 rounded-3xl p-6 relative overflow-hidden group">
            ...
            <p className="text-xs text-slate-400 leading-relaxed mb-4">Anti-Nuke is fixed to instantly Ban malicious actors. Ensure that Stela&apos;s role is at the TOP of the role hierarchy for it to be able to ban admins.</p>
