    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#020617]/80 backdrop-blur-3xl px-6 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-4 group">
          ...
          <span className="text-xl font-bold text-white font-outfit uppercase tracking-tighter">Stela Engine</span>
        </Link>
        <Link href="/">
          ...
          <div className="glass border-white/5 rounded-[40px] p-10 md:p-16 space-y-12">
            <section className="space-y-6">
              ...
              <p className="text-slate-400 leading-relaxed font-medium">
                The Stela Engine collects only the minimum necessary data to function within Discord. This includes your Discord User ID, Server (Guild) ID, and configuration settings provided during setup. We do not store message content unless explicitly configured for logging purposes by server administrators.
              </p>
            </section>
