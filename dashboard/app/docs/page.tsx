      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#020617]/80 backdrop-blur-3xl px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-4 group">
            ...
            <span className="text-xl font-bold text-white font-outfit uppercase tracking-tighter hidden md:block">Stela Docs</span>
          </Link>
        ...
        <main className="flex-1 p-8 lg:p-16 relative z-10 max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none">
             <p className="text-lg text-slate-400 mb-12 leading-relaxed">
               Welcome to the {activeTab} section of the Stela Engine documentation. Our engine is designed for communities that demand absolute performance and cinematic management tools.
             </p>
             ...
             <div className="p-8 rounded-[40px] bg-red-500/[0.02] border border-red-500/10 relative overflow-hidden">
                ...
                <p className="text-slate-500 font-bold leading-relaxed mb-8">
                  The Stela Engine utilizes a decentralized event stream processing model. When a Discord event is received, it is instantly routed to the nearest edge cluster.
                </p>
                <div className="bg-black/40 p-6 rounded-2xl border border-white/5 font-mono text-sm text-red-500 mb-8">
                  $ stela initialize --cluster-shard [neural_07] --mode enterprise
                </div>
             </div>
          </div>
