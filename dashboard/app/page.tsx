    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-red-500/30 font-sans overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer">
            ...
            <div className="flex flex-col">
              <h1 className="text-lg font-bold tracking-tight text-white font-outfit leading-none">{process.env.NEXT_PUBLIC_BRAND_NAME || "Stela"}</h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
           <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-8">
                 {[
                   { icon: Terminal, title: "Custom DSL", desc: "Write advanced logic with our intuitive Stela scripting language." },
      ...
      <section className="py-48 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              { q: "Is the Stela Engine free to use?", a: "The core engine is 100% free for all communities. We offer premium clusters for ultra-high-scale enterprise servers." },
      ...
      <section className="py-48 px-6">
        <div className="max-w-6xl mx-auto relative rounded-[80px] p-24 md:p-32 overflow-hidden bg-gradient-to-br from-red-600 to-red-900 text-center shadow-[0_40px_100px_rgba(0,0,0,0.6)]">
           ...
           <div className="relative z-10">
              ...
              <p className="text-2xl text-white/70 max-w-3xl mx-auto mb-20 font-medium">Join 5,000+ communities scaling their automation with the Stela Engine. Setup takes less than 30 seconds.</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-32">
            <div className="col-span-1 md:col-span-2 space-y-12">
              <div className="flex items-center gap-4 group">
                <span className="text-3xl font-bold text-white font-outfit uppercase tracking-tighter">{process.env.NEXT_PUBLIC_BRAND_NAME || "Stela"} Engine</span>
              </div>
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 opacity-40">
            <p className="text-slate-700 text-[10px] font-black uppercase tracking-[0.4em]">
              © 2026 {process.env.NEXT_PUBLIC_BRAND_NAME || "Stela"} Development // Advanced Neural Infrastructure.
            </p>
