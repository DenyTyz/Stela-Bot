    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#020617]/80 backdrop-blur-3xl px-6 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-4 group">
          ...
          <span className="text-xl font-bold text-white font-outfit uppercase tracking-tighter">{process.env.NEXT_PUBLIC_BRAND_NAME || "Stela"} Engine</span>
        </Link>
        <Link href="/">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass border-white/5 rounded-[40px] p-10 md:p-16 space-y-12 bg-gradient-to-br from-white/[0.01] to-transparent">
            ...
            <section className="space-y-6">
              ...
              <p className="text-slate-400 leading-relaxed font-medium">
                You may not use the {process.env.NEXT_PUBLIC_BRAND_NAME || "Stela"} Engine for any illicit activities, including but not limited to: automated harassment, token logging, or raid coordination. Violation of these constraints will result in immediate neural deauthorization and blacklisting from the global cluster network.
              </p>
            </section>
            ...
            <div className="pt-12 border-t border-white/5">
              <p className="text-[10px] font-black uppercase text-slate-600 tracking-[0.4em]">
                March 2026 // Distributed via {process.env.NEXT_PUBLIC_BRAND_NAME || "Stela"} Neural Cloud
              </p>
            </div>
          </div>
        </div>
