...
<h3>Stela Dashboard — Next.js Web Interface</h3>
...
<p>
  ...
  <a href="https://youtube.com/@StelaDevs"><img src="https://img.shields.io/badge/YouTube-StelaDevs-FF0000?style=for-the-badge&logo=youtube&logoColor=white"/></a>
...
This folder contains the Stela web dashboard built with `Next.js 14` (App Router), `TypeScript`, and `Tailwind CSS`. It connects to the bot's FastAPI backend via a permanent Cloudflare Tunnel HTTPS URL and lets server admins manage all bot settings through a sleek, branded UI.
...
|---|---|
| Node.js 18+ | — |
| Stela bot running | with `API_ENABLED=true` and `TUNNEL_ENABLED=true` |
...
<a href="https://discord.gg/steladev"><img src="https://discord.com/api/guilds/1301573144817045524/widget.png?style=banner2" alt="Stela Development Discord Server" width="480"/></a>
